...
* Если коммутатор достаточно умный, то он может подслушивать общение хостов и роутеров и использовать полученную инфу для более умной пересылки.
  * *Проблема*: У нас всегда отвечает о желании прослушивать multicast-трафик первый из группы. А как узнать, хотят ли остальные хосты все еще получать этот трафик?
