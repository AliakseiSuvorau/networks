...
* 16 бит - route tag (идентификатор маршрута)
* 32 бит - ip-адрес
* 32 бита - маска подсети
* 32 бита - next hop (аналог icmp-редиректа)
* 32 бита - метрика

![image](https://github.com/AliakseiSuvorau/networks/assets/98915109/bcf98a93-9317-44ff-88e7-e83f3a4c5748)
...
> Поле "Метка маршрута" предназначено для сигнализации внешних маршрутов и используется протоколами политики маршрутизации (к примеру, EGP).
...
![image](https://github.com/AliakseiSuvorau/networks/assets/98915109/4703d590-f759-4704-bbbb-49c365af6dd2)
